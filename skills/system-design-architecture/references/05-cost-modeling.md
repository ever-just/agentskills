...
**Related in this skill:** [`08-cloud-providers`](08-cloud-providers.md) — per-service pricing + zero-egress options · [`03-scaling-ladder`](03-scaling-ladder.md) — cost reorders as you climb rungs · [`06-architecture-archetypes`](06-architecture-archetypes.md) — the serverless-vs-container cost crossover by archetype.
